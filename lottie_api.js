        ...
        function(require, module, exports) {
          ...
          function AnimationItemFactory(animation) {
            ...
            function toKeypathLayerPoint(properties, point) {
              ...
              for (i = 0; i < len; i += 1) {
                points.push(
                  properties.getPropertyAtIndex(i).toKeypathLayerPoint(point)
                );
              }
              if (points.length === 1) {
                return points[0];
            ...
            function fromKeypathLayerPoint(properties, point) {
              ...
              for (i = 0; i < len; i += 1) {
                points.push(
                  properties.getPropertyAtIndex(i).fromKeypathLayerPoint(point)
                );
              }
              if (points.length === 1) {
                return points[0];
            ...
            function toContainerPoint(point) {
              if (
                !animation.wrapper ||
                !animation.wrapper.getBoundingClientRect
              ) {
                return point;
              }
              ...
              var newPoint = [
                point[0] - boundingRect.left,
                point[1] - boundingRect.top,
              ];
              var scaleData = state.scaleData;

              newPoint[0] =
                (newPoint[0] - scaleData.scaleXOffset) / scaleData.scale;
              newPoint[1] =
                (newPoint[1] - scaleData.scaleYOffset) / scaleData.scale;
 ...
 */
         ...
         y: x * me.b + y * me.d + me.f
            ...
            function applyToPointStringified(x, y) {
              ...
              return (
                ...
                this.props[12] +
                "," +
                (x * this.props[1] + y * this.props[5] + this.props[13])
              );
            }
        ...
        function(require, module, exports) {
          ...
          function KeyPathList(elements, node_type) {
            ...
            function getLayersByType(selector) {
              return KeyPathList(
                _filterLayerByType(elements, selector),
                "layer"
              );
            }
            ...
            function getLayersByName(selector) {
              return KeyPathList(
                _filterLayerByName(elements, selector),
                "layer"
              );
            }
        ...
        function(require, module, exports) {
          ...
          function LayerBase(state) {
            var transform = Transform(
              state.element.finalTransform.mProp,
              state
            );
            var effects = Effects(
              state.element.effectsManager.effectElements || [],
              state
            );
            ...
            function toKeypathLayerPoint(point) {
              ...
              if (element.hierarchy && element.hierarchy.length) {
                ...
                for (i = 0; i < len; i += 1) {
                  element.hierarchy[i].finalTransform.mProp.applyToMatrix(
                    toWorldMat
                  );
                }
              }
            ...
            function fromKeypathLayerPoint(point) {
              ...
              point = toWorldMat.applyToPointArray(
                point[0],
                point[1],
                point[2] || 0
              );
        ...
        function(require, module, exports) {
          ...
          function Composition(element, parent) {
            ...
            return Object.assign(
              instance,
              LayerBase(state),
              KeyPathList(state.elements, "layer"),
              methods
            );
          }
      ...
      currentTime = currentSegmentInit + currentTime;*/
                      currentTime =
                        currentTime % (currentSegmentEnd - currentSegmentInit);
                      //currentTime = currentSegmentInit + (currentTime);
                  ...
                  if (currentTime < currentSegmentEnd) {
                    ...
                    if (queuedSegments.length) {
                      ...
                      currentTime =
                        currentSegmentInit - (currentSegmentEnd - currentTime);
                    }
                  }
                }
                if (_isDebugging) {
            ...
            function addCallback() {
              if (!_isCallbackAdded) {
                ...
                _destroyFunction = instance.setValue(
                  _segmentPlayer,
                  _isDebugging
                );
              }
        ...
        function(require, module, exports) {
          ...
          function Effects(effects, parent) {
            ...
            function getValue(effectData, index) {
              ...
              var effectElement = effectData.data
                ? Effects(effectData.effectElements, parent)
                : Property(effectData.p, parent);
              return {
                name: nm,
                value: effectElement,
              };
      ...
      22: [
        function(require, module, exports) {
          ...
          function Shape(element, parent) {
            ...
            var shapeContents = ShapeContents(
              element.data.shapes,
              element.itemsData,
              state
            );
            ...
            function addAnimators() {
              ...
              for (i = 0; i < len; i += 1) {
                ...
                animatorProperties.push({
                  name:
                    element.textAnimator._textData.a[i].nm ||
                    "Animator " + (i + 1), //Fallback for old animations
                  value: textAnimator,
                });
              }
          ...
          function ValueProperty(state) {
            function setValue(value) {
              ...
              if (typeof value === "function") {
                ...
                property.propType === "multidimensional" &&
                ...
                property.propType === "unidimensional" &&
                typeof value === "number"
              ) {
                return property.addEffect(function() {
                  return value;
        ...
        function(require, module, exports) {
          ...
          function Renderer(state) {
            ...
            return Object.assign(
              ...
              KeyPathList(state.elements, "renderer")
            );
          }
